...
(function (Template) {
    async function Text() {
        ...
        await Template.ƒS.Character.show(Template.characters.Natsu, Template.characters.Natsu.pose.normal, Template.ƒS.positionPercent(50, 100));
        await Template.ƒS.update(3);
        await Template.ƒS.Speech.tell(Template.characters.Natsu, text.Natsu.T0000);
...
(function (Template) {
    ...
    function start(_event) {
        let scenes = [
            { scene: Template.Text, name: "erstesteil" }
        ];
        // start the sequence
